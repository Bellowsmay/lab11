...
public class FamilyTree
{
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            if (this.name.equals(targetName)) {
	            ...
	            for (TreeNode child: children)
	            {
	            	...
	            	TreeNode posNode = child.getNodeWithName(targetName);
	            	if (posNode != null) {
	            		return  posNode;
	            	}
	            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		else
		{
			...
			if (parentNode == null) { 
				throw new TreeException("cannot find the parent node."); 
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Cannot find node " + name1); 
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Cannot find node " + name2); 
